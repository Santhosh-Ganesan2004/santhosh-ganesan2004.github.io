          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center md:justify-start">
              <div className="relative">
                <div className="w-80 h-80 rounded-full overflow-hidden border-4 border-royal-blue/30 shadow-2xl">
                  <img
                ...
                <div className="absolute -inset-4 bg-royal-blue/20 rounded-full blur-2xl -z-10"></div>
              </div>
            </div>
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl md:text-3xl text-white mb-6 font-medium">
                <TypingAnimation text="AI + IoT Engineer" speed={80} />
              </h2>
              <div className="text-lg text-white leading-relaxed max-w-2xl">
                <TypingAnimation 
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Link
              to="/projects"
              className="group bg-gunmetal-gray hover:border-royal-blue/50 rounded-2xl p-8 border border-royal-blue/20 transition-all duration-300 hover:scale-105 shadow-lg"
            >
              ...
              <div className="flex items-center text-royal-blue group-hover:text-royal-blue transition-colors">
